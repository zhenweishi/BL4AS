...
# from lib.transforms import MultiTransforms, GaussianBlur
...
class BaseTrainer(object):
    ...
    def build_model(self):
        raise NotImplementedError("build_model method for base class Trainer has not been implemented yet.")

    def build_optimizer(self):
        raise NotImplementedError("build_optimizer method for base class Trainer has not been implemented yet.")

    def build_dataloader(self):
        raise NotImplementedError("build_dataloader method for base class Trainer has not been implemented yet.")
