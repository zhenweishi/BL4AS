...
__all__ = ["UNETR_decoder", "UNETRx8_decoder", "UNETRx8_decoderv2", "UNETRx4_decoderv2"]
...
class UNETR_decoder(nn.Module):
    ...
    def forward(self, x_in, x, hidden_states_out):
        ...
        out = self.decoder2(dec1, enc1)
        #print("out size before UnetOutBlock:", out.size())  
